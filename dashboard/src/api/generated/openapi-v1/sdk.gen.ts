 ...
 */
export const getChatSessionHistory = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetChatSessionHistoryData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetChatSessionHistoryResponse, GetChatSessionHistoryError, ThrowOnError>({
        ...options,
 ...
 */
export const getChatSessionMarkers = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetChatSessionMarkersData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetChatSessionMarkersResponse, GetChatSessionMarkersError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/{session_id}/markers'
    });
};
 ...
 */
export const getChatSessionGoal = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetChatSessionGoalData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetChatSessionGoalResponse, GetChatSessionGoalError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/{session_id}/goal'
    });
};

/**
 * Export a ChatUI session as a zip package
 */
export const exportChatSession = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ExportChatSessionData, ThrowOnError>) => {
    return (options?.client ?? client).get<ExportChatSessionResponse, ExportChatSessionError, ThrowOnError>({
        ...options,
...
/**
 * Upload a ChatUI session package and pre-check it
 */
export const importChatSessions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ImportChatSessionsData, ThrowOnError>) => {
    return (options?.client ?? client).post<ImportChatSessionsResponse, ImportChatSessionsError, ThrowOnError>({
        ...options,
        ...
        url: '/api/v1/chat/sessions/import'
    });
};

/**
 * Confirm a staged ChatUI session import
 */
export const confirmImportChatSessions = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ConfirmImportChatSessionsData, ThrowOnError>) => {
    return (options?.client ?? client).post<ConfirmImportChatSessionsResponse, ConfirmImportChatSessionsError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/sessions/import/confirm'
    });
};
...
/**
 * Unified diff between a file-change baseline backup and the current file
 */
export const chatFileChangeDiff = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ChatFileChangeDiffData, ThrowOnError>) => {
    return (options?.client ?? client).post<ChatFileChangeDiffResponse, ChatFileChangeDiffError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/file-changes/diff'
    });
};

/**
 * Restore a file to its pre-turn baseline backup
 */
export const chatFileChangeRestore = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ChatFileChangeRestoreData, ThrowOnError>) => {
    return (options?.client ?? client).post<ChatFileChangeRestoreResponse, ChatFileChangeRestoreError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/file-changes/restore'
    });
};

/**
 * Report which files already match their pre-turn baseline content
 */
export const chatFileChangeStatus = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ChatFileChangeStatusData, ThrowOnError>) => {
    return (options?.client ?? client).post<ChatFileChangeStatusResponse, ChatFileChangeStatusError, ThrowOnError>({
        ...options,
        url: '/api/v1/chat/file-changes/status'
    });
};
...
/**
 * Get the dashboard-editable update sources
 * Returns the update source URLs that the settings page may edit, each with its effective value, built-in default, and whether an environment variable overrides the config file.
 */
export const getUpdateSources = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetUpdateSourcesResponse, GetUpdateSourcesError, ThrowOnError>({
        ...options,
        url: '/api/v1/updates/sources'
    });
};

/**
 * Save the dashboard-editable update sources
 * Persists the submitted update sources to data/update_config.json, leaving omitted fields and all unrelated keys untouched. Invalid values are answered with the normal 200 envelope carrying status=error and the validation message.
 */
export const saveUpdateSources = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SaveUpdateSourcesData, ThrowOnError>) => {
    return (options?.client ?? client).put<SaveUpdateSourcesResponse, SaveUpdateSourcesError, ThrowOnError>({
        ...options,
        url: '/api/v1/updates/sources'
    });
};
...
/**
 * List agent teams owned by the current user
 */
export const listAgentTeams = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAgentTeamsResponse, ListAgentTeamsError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams'
    });
};

/**
 * Create a team and all member sessions
 */
export const createAgentTeam = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAgentTeamData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAgentTeamResponse, CreateAgentTeamError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams'
    });
};
 ...
 * Get one team
 */
export const getAgentTeam = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAgentTeamData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAgentTeamResponse, GetAgentTeamError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}'
    });
};

/**
 * Update team name/coordinator/config
 */
export const updateAgentTeam = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAgentTeamData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateAgentTeamResponse, UpdateAgentTeamError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}'
    });
};
...
/**
 * Delete a team (member sessions are preserved)
 */
export const deleteAgentTeam = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAgentTeamData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAgentTeamResponse, DeleteAgentTeamError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}'
    });
};
...
/**
 * Add a member (creates its WebChat session server-side)
 */
export const addAgentTeamMember = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<AddAgentTeamMemberData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddAgentTeamMemberResponse, AddAgentTeamMemberError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/members'
    });
};
 ...
 * Remove a member
 */
export const removeAgentTeamMember = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RemoveAgentTeamMemberData, ThrowOnError>) => {
    return (options?.client ?? client).delete<RemoveAgentTeamMemberResponse, RemoveAgentTeamMemberError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/members/{member_id}'
    });
};

/**
 * List the team's workflow templates
 */
export const listAgentTeamWorkflows = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAgentTeamWorkflowsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAgentTeamWorkflowsResponse, ListAgentTeamWorkflowsError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/workflows'
    });
};
 ...
 */
export const createAgentTeamWorkflow = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateAgentTeamWorkflowData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAgentTeamWorkflowResponse, CreateAgentTeamWorkflowError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/workflows'
    });
};
...
/**
 * Update a workflow template (graph + layout, server-validated)
 */
export const updateAgentTeamWorkflow = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateAgentTeamWorkflowData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAgentTeamWorkflowResponse, UpdateAgentTeamWorkflowError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/workflows/{workflow_id}'
    });
};
 ...
 */
export const deleteAgentTeamWorkflow = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteAgentTeamWorkflowData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAgentTeamWorkflowResponse, DeleteAgentTeamWorkflowError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/workflows/{workflow_id}'
    });
};
...
/**
 * List the team's run history (full rows incl. graph/node_states)
 */
export const listAgentTeamRuns = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListAgentTeamRunsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListAgentTeamRunsResponse, ListAgentTeamRunsError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/runs'
    });
};

/**
 * Start a run (409 when the team already has an active run)
 */
export const startAgentTeamRun = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StartAgentTeamRunData, ThrowOnError>) => {
    return (options?.client ?? client).post<StartAgentTeamRunResponse, StartAgentTeamRunError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/{team_id}/runs'
    });
};
...
/**
 * List the user's active runs with snapshots
 */
export const listActiveAgentTeamRuns = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<ListActiveAgentTeamRunsResponse, ListActiveAgentTeamRunsError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/active'
    });
};
 ...
 * Pause a run
 */
export const pauseAgentTeamRun = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PauseAgentTeamRunData, ThrowOnError>) => {
    return (options?.client ?? client).post<PauseAgentTeamRunResponse, PauseAgentTeamRunError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/pause'
    });
};
 ...
 */
export const resumeAgentTeamRun = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ResumeAgentTeamRunData, ThrowOnError>) => {
    return (options?.client ?? client).post<ResumeAgentTeamRunResponse, ResumeAgentTeamRunError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/resume'
    });
};
 ...
 * Stop a run
 */
export const stopAgentTeamRun = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StopAgentTeamRunData, ThrowOnError>) => {
    return (options?.client ?? client).post<StopAgentTeamRunResponse, StopAgentTeamRunError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/stop'
    });
};
 ...
 * Retry a failed node
 */
export const retryAgentTeamNode = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RetryAgentTeamNodeData, ThrowOnError>) => {
    return (options?.client ?? client).post<RetryAgentTeamNodeResponse, RetryAgentTeamNodeError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/nodes/{node_id}/retry'
    });
};

/**
 * Skip a failed node and cascade-skip its successors
 */
export const skipAgentTeamNode = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SkipAgentTeamNodeData, ThrowOnError>) => {
    return (options?.client ?? client).post<SkipAgentTeamNodeResponse, SkipAgentTeamNodeError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/nodes/{node_id}/skip'
    });
};

/**
 * Interrupt one member's in-flight turn
 */
export const interruptAgentTeamMember = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<InterruptAgentTeamMemberData, ThrowOnError>) => {
    return (options?.client ?? client).post<InterruptAgentTeamMemberResponse, InterruptAgentTeamMemberError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/members/{member_id}/interrupt'
    });
};

/**
 * Page one member's transcript rows chronologically
 */
export const getAgentTeamMemberTranscript = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetAgentTeamMemberTranscriptData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAgentTeamMemberTranscriptResponse, GetAgentTeamMemberTranscriptError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/members/{member_id}/transcript'
    });
};

/**
 * Server-sent events for one run (full history replay, then live, heartbeats)
 */
export const streamAgentTeamRun = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StreamAgentTeamRunData, ThrowOnError>) => {
    return (options?.client ?? client).get<StreamAgentTeamRunResponse, StreamAgentTeamRunError, ThrowOnError>({
        ...options,
        url: '/api/v1/agent_teams/runs/{run_id}/stream'
    });
};